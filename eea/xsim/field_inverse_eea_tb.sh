...
#
# Script generated by Vivado on Sat Jul 12 14:17:32 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : field_inverse_eea_tb.sh
...
#
# Usage        : field_inverse_eea_tb.sh
#                field_inverse_eea_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                field_inverse_eea_tb.sh [-reset_run]
#                field_inverse_eea_tb.sh [-reset_log]
#                field_inverse_eea_tb.sh [-help]
#
...
# script info
echo -e "field_inverse_eea_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./field_inverse_eea_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot field_inverse_eea_tb xil_defaultlib.field_inverse_eea_tb -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim field_inverse_eea_tb -key {Behavioral:sim_1:Functional:field_inverse_eea_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb field_inverse_eea_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./field_inverse_eea_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: field_inverse_eea_tb.sh [-help]\n\
Usage: field_inverse_eea_tb.sh [-step]\n\
Usage: field_inverse_eea_tb.sh [-lib_map_path]\n\
Usage: field_inverse_eea_tb.sh [-reset_run]\n\
Usage: field_inverse_eea_tb.sh [-reset_log]\n\
Usage: field_inverse_eea_tb.sh [-keep_index]\n\
Usage: field_inverse_eea_tb.sh [-noclean_files]\n\n\
